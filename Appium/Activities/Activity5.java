...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(MobileBy.AndroidUIAutomator(contactBoxLocator)).sendKeys("9704703551");
        ...
        // Type in a message
        driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"com.google.android.apps.messaging:id/compose_message_text\")")).sendKeys("Welcome from Appium");
